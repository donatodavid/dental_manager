...
export const INITIAL_BRANCHES: Branch[] = [
  {
    id: 'branch-1',
    name: 'Sucursal Maipú (Edificio Salman)',
...
export const INITIAL_PATIENTS: Patient[] = [
    ...
    evolutions: [
      {
        ...
        signed: true,
        signatureStamp: 'Firma Digital Validada - Dr. Jorge de Luque (Reg. 84920) - 2026-08-20 12:15:32 CLT',
        teethInvolved: [16]
      },
      {
        id: 'evo-2',
        ...
        signed: true,
        signatureStamp: 'Firma Digital Validada - Dr. Jorge de Luque (Reg. 84920) - 2026-07-05 15:45:00 CLT'
      }
    ],
    documents: [
      {
    ...
    evolutions: [
      {
        ...
        signed: true,
        signatureStamp: 'Firma Digital Validada - Dr. Alejandro David (Reg. 72109) - 2026-08-22 09:50:11 CLT',
        teethInvolved: [14]
      }
    ],
    documents: [
    ...
    evolutions: [
      {
        ...
        doctorId: 'doc-1',
        doctorName: 'Dr. Jorge de Luque',
        specialty: 'Rehabilitación Oral & Odontopediatría',
        branchId: 'branch-1',
        ...
        signed: true,
        signatureStamp: 'Firma Digital Validada - Dr. Jorge de Luque (Reg. 84920) - 2026-08-25 16:40:00 CLT'
      }
    ],
    documents: [],
    status: 'ACTIVE',
  ...
  },
  {
    ...
    address: 'Calle Independencia 340',
    city: 'Linares',
    ...
    evolutions: [
      {
        ...
        specialty: 'Implantología & Cirugía Oral',
        branchId: 'branch-1',
        subjective: 'Control de tratamiento de pieza 1.2 realizada hace 1 mes.',
        objective: 'Asintomático, mucosa peri-apical sana, sin fístula ni dolor a la palpación.',
        assessment: 'Evolución favorable post-tratamiento.',
        plan: 'Alta clínica de pieza 1.2. Se deriva a Dr. Jorge de Luque para restauración definitiva con corona de zirconio.',
        signed: true,
        signatureStamp: 'Firma Digital Validada - Dr. Alejandro David (Reg. 72109) - 2026-08-26 15:05:00 CLT',
        teethInvolved: [12]
      }
    ],
    documents: [],
...
export const INITIAL_APPOINTMENTS: Appointment[] = [
  ...
  },
  {
    ...
    doctorId: 'doc-2',
    doctorName: 'Dr. Alejandro David',
    doctorSpecialty: 'Implantología & Cirugía Oral',
    branchId: 'branch-1',
    branchName: 'Sucursal Maipú (Edificio Salman)',
